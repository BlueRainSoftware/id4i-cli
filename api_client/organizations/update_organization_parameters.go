...
type UpdateOrganizationParams struct {
	...
	*/
	OrganizationUpdate *api_models.OrganizationUpdate
...
// WithOrganizationUpdate adds the organizationUpdate to the update organization params
func (o *UpdateOrganizationParams) WithOrganizationUpdate(organizationUpdate *api_models.OrganizationUpdate) *UpdateOrganizationParams {
	o.SetOrganizationUpdate(organizationUpdate)
	return o
}

// SetOrganizationUpdate adds the organizationUpdate to the update organization params
func (o *UpdateOrganizationParams) SetOrganizationUpdate(organizationUpdate *api_models.OrganizationUpdate) {
	o.OrganizationUpdate = organizationUpdate
}
...
func (o *UpdateOrganizationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.OrganizationUpdate != nil {
		if err := r.SetBodyParam(o.OrganizationUpdate); err != nil {
			return err
		}
	}
