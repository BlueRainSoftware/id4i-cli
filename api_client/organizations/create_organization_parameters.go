...
func (o *CreateOrganizationParams) WithOrganization(organization *api_models.Organization) *CreateOrganizationParams {
	o.SetOrganization(organization)
	return o
}

// SetOrganization adds the organization to the create organization params
func (o *CreateOrganizationParams) SetOrganization(organization *api_models.Organization) {
