...
type LoginParams struct {
	...
	/*AccountCredentials*/
	AccountCredentials *api_models.AccountCredentials
...
// WithAccountCredentials adds the accountCredentials to the login params
func (o *LoginParams) WithAccountCredentials(accountCredentials *api_models.AccountCredentials) *LoginParams {
	o.SetAccountCredentials(accountCredentials)
	return o
}

// SetAccountCredentials adds the accountCredentials to the login params
func (o *LoginParams) SetAccountCredentials(accountCredentials *api_models.AccountCredentials) {
	o.AccountCredentials = accountCredentials
}
...
func (o *LoginParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AccountCredentials != nil {
		if err := r.SetBodyParam(o.AccountCredentials); err != nil {
			return err
		}
	}
